...
<head>
  ...
  <title>Belajar Laravel Teknik Informatika</title>
        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
                <img src="assets/img/logounp.png" alt="BootstrapBrain Logo" width="250">
              </a>
            </div>
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Silahkan Masukan Email & Password !</h2>
